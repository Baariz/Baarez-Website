                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex gap-3">
                            <select 
                                ...
                                className="w-28 px-2 py-3 bg-[#fcfcfc] border border-gray-100 focus:border-[#ef7f25] outline-none text-sm truncate"
                            >
                                {COUNTRY_DATA.map(c => (
                            ...
                            <input 
                                ...
                                className={`flex-1 px-4 py-3 bg-[#fcfcfc] border ${errors.phone_number ? 'border-red-500' : 'border-gray-100'} focus:border-[#ef7f25] outline-none text-sm`} 
                            />
                        </div>
                  ...
                  <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <input type="text" name="annual_revenue" value={formData.annual_revenue} onChange={handleChange} placeholder="e.g. $1M - $5M" className={`w-full px-4 py-3 bg-[#fcfcfc] border ${errors.annual_revenue ? 'border-red-500' : 'border-gray-100'} focus:border-[#ef7f25] outline-none text-sm`} />
                        ...
                        <div className="space-y-2">
                            ...
                            <input type="text" name="number_of_clients" value={formData.number_of_clients} onChange={handleChange} placeholder="e.g. 50+" className={`w-full px-4 py-3 bg-[#fcfcfc] border ${errors.number_of_clients ? 'border-red-500' : 'border-gray-100'} focus:border-[#ef7f25] outline-none text-sm`} />
