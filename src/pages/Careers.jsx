...
const Careers = () => {
  return (
    <div className="bg-[#fdfbf9] font-sans text-[#2d2a2a] selection:bg-[#ef7f25] selection:text-white pt-20">

      {/* 1. HERO SECTION */}
      <section className="relative py-24 px-6 border-b border-gray-100 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <FadeIn>
            <span className="text-[#ef7f25] font-bold uppercase tracking-[0.2em] text-xs mb-4 block">
              Careers at Baarez
            </span>
            <h1 className="text-3xl md:text-4xl font-bold text-[#760015] mb-6">
              Do Work That Matters.
            </h1>
            <p className="text-sm text-gray-600 leading-relaxed max-w-2xl mx-auto mb-8">
              Baarez Technology Solutions builds software that helps big companies stay safe and follow the rules. We use smart technology to solve complex problems in simple ways.
            </p>
            
            <div className="flex justify-center">
               <a 
                href="https://in.linkedin.com/company/the-baarez-technology-solutions" 
                target="_blank" 
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <FadeIn>
              <h2 className="text-[#ef7f25] font-bold uppercase tracking-[0.2em] text-xs mb-3">Who We Are</h2>
              <h3 className="text-3xl md:text-4xl font-bold text-[#2d2a2a] mb-6">
            ...
            <div className="grid gap-6">
               {[
                 ...
                 <FadeIn key={i} delay={i * 0.1}>
                    <div className="flex items-start gap-4 p-4 bg-white border border-gray-100 rounded-xl shadow-sm hover:border-[#ef7f25]/50 transition-colors">
                      <div className="w-10 h-10 bg-[#fdfbf9] rounded-lg flex items-center justify-center text-[#760015] shrink-0">
                        <item.icon size={20} />
                      </div>
                      <div>
                        <h4 className="text-xl font-bold text-[#760015] mb-1">{item.title}</h4>
      ...
      <section className="py-20 bg-gray-50 border-t border-gray-100">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-[#ef7f25] font-bold uppercase tracking-[0.2em] text-xs mb-3">Our Culture</h2>
            ...
            {[
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <div className="h-full bg-white p-8 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow text-center">
                  <div className="w-12 h-12 bg-[#ef7f25]/10 text-[#ef7f25] rounded-full flex items-center justify-center mx-auto mb-4">
                    <Smile size={24} />
                  </div>
                  <h4 className="text-xl font-bold text-[#760015] mb-3">{card.title}</h4>
        ...
        <div className="max-w-3xl mx-auto px-6 text-center">
          <FadeIn>
            ...
            <div className="bg-[#fdfbf9] border border-gray-200 rounded-xl p-10 mt-8">
              <h3 className="text-xl font-bold text-[#760015] mb-3">
