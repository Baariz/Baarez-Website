      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-white border border-gray-100 shadow-sm p-8 md:p-16 space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={idx} className="bg-[#FCFCFC] p-4 border border-gray-50">
                    <span className="block font-bold text-[#ef7f25] text-xs uppercase mb-1">{item.term}</span>
            ...
            <div>
              <h3 className="text-[#760015] font-bold text-lg mb-4">What Information Do We Collect?</h3>
            ...
            <div className="bg-[#760015] p-8 text-white">
            ...
            {/* 5. Security */}
            <div>
              <h3 className="text-[#760015] font-bold text-lg mb-4">Data Security & Protection</h3>
            ...
            <div>
              <h3 className="text-[#760015] font-bold text-lg mb-4">International Data Transfers</h3>
              <p className="text-sm text-gray-600 leading-relaxed">
            ...
            {/* 7. GDPR & CCPA */}
            <div className="border-l-4 border-[#ef7f25] pl-6 py-2">
              <h3 className="text-[#2d2a2a] font-bold text-lg mb-4 uppercase tracking-tighter">Global Compliance (GDPR & CCPA)</h3>
              <p className="text-sm text-gray-600 leading-relaxed">
            ...
            <div className="pt-10 border-t border-gray-100">
              <h3 className="text-[#760015] font-bold text-lg mb-6">Contact Us</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-gray-600">
                <div>
                  <span className="block font-bold text-[#ef7f25] text-[10px] uppercase mb-2">Support Channels</span>
                  <p>Email: info@baarez.com</p>
                  <p>Phone: +974 44164978</p>
                </div>
                <div>
                  <span className="block font-bold text-[#ef7f25] text-[10px] uppercase mb-2">Registered Address</span>
