...
const ServiceCard = ({ item }) => (
  ...
  >
    <div className="absolute top-0 right-0 p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
      <Icons.ArrowUpRight className="w-5 h-5 text-[#ef7f25]" />
    </div>

    <div className="w-14 h-14 bg-gray-50 rounded-lg flex items-center justify-center text-[#760015] mb-6 group-hover:bg-[#760015] group-hover:text-white transition-colors duration-300">
...
const Services = () => {
  return (
    <div className="min-h-screen bg-[#faf9f6] font-sans text-[#2d2a2a] pt-20">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="max-w-2xl">
              <div className="flex items-center gap-3 mb-6">
                <span className="w-12 h-[2px] bg-[#ef7f25]"></span>
            ...
            <div className="relative h-[400px] w-full hidden lg:flex items-center justify-center">
                ...
                <div className="absolute w-[280px] h-[280px] border border-dashed border-[#ef7f25]/30 rounded-full animate-[spin_40s_linear_infinite_reverse]"></div>
                ...
                <motion.div 
                    ...
                    className="absolute top-10 left-10 bg-white p-4 rounded-xl shadow-lg border-l-4 border-[#760015] z-20"
                >
                    <Icons.Briefcase className="w-6 h-6 text-[#760015] mb-2" />
                    <p className="text-xs font-bold text-[#2d2a2a] uppercase">Strategy</p>
                </motion.div>
                ...
                <motion.div 
                    ...
                    className="absolute top-20 right-0 bg-white p-4 rounded-xl shadow-lg border-l-4 border-[#ef7f25] z-20"
                >
                    <Icons.Brain className="w-6 h-6 text-[#ef7f25] mb-2" />
                    <p className="text-xs font-bold text-[#2d2a2a] uppercase">Intelligence</p>
                </motion.div>
                ...
                <motion.div 
                    ...
                    className="absolute bottom-10 left-20 bg-white p-4 rounded-xl shadow-lg border-l-4 border-[#2d2a2a] z-20"
                >
                    <Icons.ShieldCheck className="w-6 h-6 text-[#2d2a2a] mb-2" />
                    <p className="text-xs font-bold text-[#2d2a2a] uppercase">Resilience</p>
                </motion.div>
          ...
          <div className="grid md:grid-cols-4 gap-8 text-left relative">
            ...
            {[
              ...
              <div key={i} className="relative z-10 group">
                <div className="w-24 h-24 bg-[#760015] border border-white/20 rounded-full flex items-center justify-center text-3xl font-bold mb-6 group-hover:bg-[#ef7f25] group-hover:border-[#ef7f25] transition-colors duration-300 shadow-xl mx-auto md:mx-0">
                  {phase.step}
                </div>
                <h4 className="text-xl font-bold mb-2 text-[#ef7f25] text-center md:text-left">{phase.title}</h4>
      ...
      <section className="py-24 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/contact" className="px-10 py-4 bg-[#2d2a2a] text-white font-bold uppercase tracking-widest text-xs rounded hover:bg-[#760015] transition-colors shadow-lg">
              Book a Consultation
            </Link>
            <Link to="/solutions" className="px-10 py-4 bg-white text-[#2d2a2a] border border-gray-200 font-bold uppercase tracking-widest text-xs rounded hover:border-[#760015] hover:text-[#760015] transition-colors">
              Explore Platforms
            </Link>
          </div>
        </div>
