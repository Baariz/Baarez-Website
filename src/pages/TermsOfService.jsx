        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-white border border-gray-100 shadow-sm p-8 md:p-16 space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
              <div className="md:col-span-4">
                <div className="flex items-center gap-2 mb-2">
                  <FileText className="w-4 h-4 text-[#ef7f25]" />
                  <h3 className="text-[#760015] font-bold text-sm uppercase tracking-wider">Definitions</h3>
                </div>
              </div>
              <div className="md:col-span-8 prose prose-sm text-gray-600">
                <p>
                  In these terms and conditions, <strong>“we”</strong>, <strong>“our”</strong> and <strong>“us”</strong> refer to Baarez Technology Solutions. 
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start pt-8 border-t border-gray-50">
              <div className="md:col-span-4">
                <div className="flex items-center gap-2 mb-2">
                  <Zap className="w-4 h-4 text-[#ef7f25]" />
                  <h3 className="text-[#760015] font-bold text-sm uppercase tracking-wider">Services</h3>
                </div>
              </div>
              <div className="md:col-span-8 prose prose-sm text-gray-600">
                <p>
                  Baarez Technology Solutions provides technology and software development services, 
            ...
            <div className="bg-[#FCFCFC] p-8 border border-gray-50">
              <h3 className="text-[#760015] font-bold text-lg mb-4 flex items-center gap-2">
                <Shield className="w-5 h-5 text-[#ef7f25]" /> Intellectual Property
              </h3>
              <p className="text-sm text-gray-600 leading-relaxed mb-6">
                Baarez Technology Solutions retains all rights, title, and interest in its intellectual property, 
              ...
              <h4 className="text-[#2d2a2a] font-bold text-xs uppercase tracking-widest mb-3">User Content License</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start pt-8 border-t border-gray-50">
              <div className="md:col-span-4">
                <div className="flex items-center gap-2 mb-2">
                  <Lock className="w-4 h-4 text-[#ef7f25]" />
                  <h3 className="text-[#760015] font-bold text-sm uppercase tracking-wider">Confidentiality</h3>
                </div>
              </div>
              <div className="md:col-span-8 prose prose-sm text-gray-600">
                <p>
                  ...
                  to Baarez Technology Solutions encountered during our engagement.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start pt-8 border-t border-gray-50">
              <div className="md:col-span-4">
                <div className="flex items-center gap-2 mb-2">
                  <AlertCircle className="w-4 h-4 text-[#ef7f25]" />
                  <h3 className="text-[#760015] font-bold text-sm uppercase tracking-wider">Liability</h3>
                </div>
              </div>
              <div className="md:col-span-8 prose prose-sm text-gray-600">
                <p className="mb-4">
                  Baarez Technology Solutions shall not be liable for any direct, indirect, or consequential 
                  damages arising out of your use of our services.
                </p>
                <p>
                  You agree to indemnify and hold harmless Baarez Technology Solutions from any claims 
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start pt-8 border-t border-gray-50">
              <div className="md:col-span-4">
                <div className="flex items-center gap-2 mb-2">
                  <Gavel className="w-4 h-4 text-[#ef7f25]" />
                  <h3 className="text-[#760015] font-bold text-sm uppercase tracking-wider">Governing Law</h3>
                </div>
              </div>
              <div className="md:col-span-8 prose prose-sm text-gray-600">
                <p>
            ...
            <div className="pt-10 border-t border-gray-100 flex flex-col md:flex-row justify-between items-start gap-8">
              <div className="text-sm text-gray-600">
                <h3 className="text-[#760015] font-bold mb-2">Legal Inquiries</h3>
                <p>Email: info@baarez.com</p>
                <p className="mt-4">
                  For information on data handling, visit our <Link to="/privacy" className="text-[#ef7f25] font-bold hover:underline">Privacy Policy</Link>.
                </p>
              </div>
              <div className="bg-[#760015] p-6 text-white max-w-xs shadow-lg">
                <p className="text-[10px] uppercase tracking-[0.2em] font-bold mb-2 text-[#ef7f25]">Notice</p>
