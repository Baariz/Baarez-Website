      ...
      <section className="relative pt-32 pb-24 lg:pt-40 px-6 lg:px-12 max-w-[1800px] mx-auto border-b border-gray-100">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              We help enterprises move beyond the hype. Baarez builds, governs, and scales AI systems that drive measurable operational efficiency and innovation.
            </motion.p>
            ...
            >
              <Link 
                to="/contact" 
                className="px-10 py-4 bg-[#760015] text-white font-bold text-xs uppercase tracking-widest hover:bg-[#5a0010] transition-colors rounded-none text-center shadow-lg"
              >
            ...
            <div className="relative w-full max-w-sm">
                ...
                >
                    <div className="flex justify-between items-center mb-2">
                        <span className="text-xs font-bold text-[#ef7f25] uppercase tracking-wider">Experience Layer</span>
                        <Icons.Brain className="w-5 h-5 text-[#ef7f25]" />
                    </div>
                    <h3 className="text-xl font-bold text-[#2d2a2a]">Intelligent Apps</h3>
                ...
                >
                    <div className="flex justify-between items-center mb-2">
                        <span className="text-xs font-bold text-[#760015] uppercase tracking-wider">Model Layer</span>
                        <Icons.Cpu className="w-5 h-5 text-[#760015]" />
                    </div>
                    <h3 className="text-xl font-bold text-[#2d2a2a]">Custom Models</h3>
                ...
                >
                    ...
                    <h3 className="text-xl font-bold text-[#2d2a2a]">Data Infrastructure</h3>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-center gap-4">
                    ...
                    <span className="text-sm font-bold text-[#2d2a2a] uppercase tracking-wide">{item}</span>
                  </li>
                ))}
              </ul>
            </motion.div>
          ...
          >
            {[
              ...
              <motion.div 
                key={i} 
                variants={fadeInUp}
                className="group relative px-6 py-3 bg-white border border-gray-200 hover:border-[#760015] transition-all duration-300 cursor-default flex items-center gap-3 overflow-hidden"
              >
                {/* Active Dot Indicator */}
                <span className="w-2 h-2 rounded-full bg-gray-300 group-hover:bg-[#ef7f25] group-hover:shadow-[0_0_8px_rgba(239,127,37,0.6)] transition-all duration-300"></span>
                
                <span className="text-sm font-bold text-gray-600 group-hover:text-[#2d2a2a] transition-colors">
                  {tag}
                </span>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12">
            ...
            <div className="hidden md:block">
              <Link to="/contact" className="text-sm font-bold text-[#ef7f25] hover:text-[#760015] transition-colors flex items-center gap-2">
          ...
          >
             {[
               ...
               <motion.div 
                 key={i} 
                 variants={fadeInUp}
                 className="p-8 bg-[#faf9f6] border border-transparent hover:border-[#ef7f25] hover:bg-white hover:shadow-lg transition-all duration-300 group flex flex-col justify-between h-40"
               >
                 <div className="flex justify-between items-start">
                   <Icons.Industry className="w-6 h-6 text-gray-300 group-hover:text-[#760015] transition-colors" />
                   <Icons.Arrow className="w-4 h-4 text-transparent group-hover:text-[#ef7f25] -translate-x-2 group-hover:translate-x-0 transition-all duration-300" />
                 </div>
                 
                 <div>
                   <h4 className="font-bold text-[#2d2a2a] text-sm group-hover:text-[#760015] transition-colors">
                     {ind}
                   </h4>
                   <div className="w-0 group-hover:w-8 h-[2px] bg-[#ef7f25] mt-2 transition-all duration-500"></div>
                 </div>
               </motion.div>
             ))}
          </motion.div>
