    ...
    <div className="min-h-screen bg-white font-sans text-[#2d2a2a] selection:bg-[#ef7f25] selection:text-white overflow-x-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <motion.div 
              ...
              className="inline-flex items-center gap-2 mb-8 border-b border-[#ef7f25] pb-2"
            >
              <span className="text-[#ef7f25] font-bold uppercase tracking-[0.2em] text-xs">
                Process Excellence
              </span>
            </motion.div>
            ...
            >
              We restructure enterprise operations for the AI age. Baarez combines strategic consulting with data science to build processes that scale effortlessly.
            </motion.p>
            ...
            >
              <Link 
                to="/contact" 
                className="px-10 py-4 bg-[#760015] text-white font-bold text-xs uppercase tracking-widest hover:bg-[#5a0010] transition-colors rounded-none shadow-lg text-center"
              >
          ...
          <div className="h-[500px] flex gap-4 lg:pl-8">
            ...
            >
              <div className="absolute top-0 left-0 w-full h-1 bg-[#ef7f25]"></div>
              <Icons.Chart className="w-8 h-8 text-[#ef7f25] mb-4" />
              <div className="text-3xl font-bold text-[#2d2a2a] mb-1">+40%</div>
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-[#760015]/10 mix-blend-multiply"></div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="flex-1 bg-[#760015] relative overflow-hidden flex flex-col justify-end p-6 text-white"
            >
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="space-y-6">
              {[
                ...
                <div key={i} className="flex gap-4 border-l-2 border-gray-200 pl-4 hover:border-[#ef7f25] transition-colors">
                  <div>
                    <h4 className="font-bold text-[#2d2a2a] text-sm mb-1">{item.title}</h4>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h4 className="text-xl font-bold text-[#2d2a2a]">Project Management as a Service (PMaaS)</h4>
                <Icons.Strategy className="w-6 h-6 text-[#760015]" />
              </div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-xs text-gray-500"><Icons.Check className="w-3 h-3 text-[#ef7f25]" /> Delivery Assurance</li>
                <li className="flex items-center gap-2 text-xs text-gray-500"><Icons.Check className="w-3 h-3 text-[#ef7f25]" /> Risk Mitigation</li>
              </ul>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h4 className="text-xl font-bold text-[#2d2a2a]">Business Process Re-engineering (BPR)</h4>
                <Icons.Process className="w-6 h-6 text-[#760015]" />
              </div>
              <p className="text-sm text-gray-600 mb-6 leading-relaxed">
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-xs text-gray-500"><Icons.Check className="w-3 h-3 text-[#ef7f25]" /> Workflow Optimization</li>
                <li className="flex items-center gap-2 text-xs text-gray-500"><Icons.Check className="w-3 h-3 text-[#ef7f25]" /> Cost Reduction</li>
              </ul>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h4 className="text-xl font-bold text-[#2d2a2a]">Process Assessments</h4>
                <Icons.Search className="w-6 h-6 text-[#760015]" />
              </div>
              <p className="text-sm text-gray-600 mb-6 leading-relaxed">
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-xs text-gray-500"><Icons.Check className="w-3 h-3 text-[#ef7f25]" /> Maturity Scoring</li>
                <li className="flex items-center gap-2 text-xs text-gray-500"><Icons.Check className="w-3 h-3 text-[#ef7f25]" /> Roadmap Creation</li>
              </ul>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h4 className="text-xl font-bold text-[#2d2a2a]">Solution Architecture</h4>
                <Icons.Brain className="w-6 h-6 text-[#760015]" />
              </div>
              <p className="text-sm text-gray-600 mb-6 leading-relaxed">
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-xs text-gray-500"><Icons.Check className="w-3 h-3 text-[#ef7f25]" /> Tech Stack Modernization</li>
                <li className="flex items-center gap-2 text-xs text-gray-500"><Icons.Check className="w-3 h-3 text-[#ef7f25]" /> Integration Strategy</li>
              </ul>
            </motion.div>
      ...
      <section className="py-20 bg-white border-t border-gray-100">
        <div className="max-w-[1200px] mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex items-center gap-6">
                  <div className="w-16 text-3xl font-bold text-[#ef7f25]">{stat.val}</div>
                  <div className="flex-1 border-b border-gray-100 pb-2">
                    <h5 className="font-bold text-[#2d2a2a] text-sm">{stat.label}</h5>
          ...
          <div className="order-1 lg:order-2 relative h-[400px]">
            <div className="absolute top-0 right-0 w-full h-full border border-[#760015] translate-x-4 translate-y-4"></div>
            <img 
      ...
      <section className="py-20 bg-[#faf9f6]">
        <div className="max-w-[1000px] mx-auto px-6 text-center">
          <h2 className="text-[#760015] font-bold uppercase tracking-[0.2em] mb-6 text-xs">
            The Baarez Difference
          </h2>
