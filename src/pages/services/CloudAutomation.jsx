    ...
    <div className="min-h-screen bg-white font-sans text-[#2d2a2a] selection:bg-[#ef7f25] selection:text-white overflow-x-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="h-[500px] flex items-center justify-center relative border-l border-gray-100 lg:pl-16">
            <div className="relative w-full max-w-md aspect-square flex items-center justify-center">
              ...
              >
                <div className="absolute top-0 left-1/2 w-4 h-4 bg-[#ef7f25] rounded-full -translate-x-1/2 -translate-y-1/2 shadow-md"></div>
              </motion.div>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-white p-8 border border-gray-200">
              <h4 className="font-bold text-[#2d2a2a] mb-6 border-b border-gray-100 pb-4">Operational Maturity</h4>
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between group">
                    ...
                    <Icons.ArrowRight className="w-4 h-4 text-[#ef7f25]" />
                    <span className="text-sm font-bold text-[#2d2a2a]">{item.to}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-24 bg-[#fdfbf9] border-b border-gray-100">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <h2 className="text-[#ef7f25] font-bold uppercase tracking-[0.2em] mb-12 text-xs">
            Why Automate?
          </h2>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-8 border border-gray-100 shadow-sm">
                ...
                <div className="text-xs font-bold text-[#2d2a2a] uppercase mb-2">{stat.label}</div>
              ...
              <div className="md:w-2/3">
                ...
                <ul className="space-y-2">
                  {["Identity & Access Management (IAM)", "Automated Compliance Audits", "Disaster Recovery Automation"].map((item, i) => (
                    <li key={i} className="flex items-center gap-3 text-sm text-[#2d2a2a]">
                      <Icons.Check className="w-4 h-4 text-[#ef7f25]" /> {item}
                    </li>
                  ))}
                </ul>
              </div>
              <div className="md:w-1/3 flex justify-center">
                <div className="w-24 h-24 bg-[#760015] flex items-center justify-center rounded-full text-white">
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-70 grayscale hover:grayscale-0 transition-all duration-500">
            {["AWS", "Microsoft Azure", "Google Cloud", "Kubernetes", "Terraform", "Ansible"].map((tech, i) => (
              <span key={i} className="text-xl font-bold text-[#2d2a2a]">{tech}</span>
            ))}
          </div>
        </div>
      </section>
