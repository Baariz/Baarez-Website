    ...
    <div className="min-h-screen bg-white font-sans text-[#2d2a2a] selection:bg-[#ef7f25] selection:text-white">
      ...
      <section className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 px-6 lg:px-12 max-w-[1800px] mx-auto border-b border-gray-100">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-6 relative z-10">
            ...
            >
              <div className="w-2 h-2 bg-[#ef7f25] rounded-full animate-pulse"></div>
              <span className="text-xs font-bold text-[#2d2a2a] uppercase tracking-widest">
                Data Ecosystem
              </span>
            </motion.div>
          ...
          <div className="lg:col-span-6 relative">
            ...
            >
              {[
                { label: "Raw Data", value: "Revenue +30%", sub: "Predictive Sales", color: "bg-[#ef7f25]", icon: Icons.TrendingUp },
                { label: "Silos", value: "Unified View", sub: "Data Lakehouse", color: "bg-[#760015]", icon: Icons.Database },
                { label: "Latency", value: "Real-Time", sub: "Decision Engine", color: "bg-[#2d2a2a]", icon: Icons.Cpu },
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex gap-4">
                <div className="h-full w-1 bg-[#760015]"></div>
                <p className="text-sm text-gray-500 italic">
                  "Baarez moves you from fragmented silos to a unified intelligence ecosystem."
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-px bg-gray-100 border border-gray-100">
              {[
                ...
                <div key={i} className="bg-white p-8 hover:bg-[#faf9f6] transition-colors">
                  <div className="text-3xl font-bold text-[#2d2a2a] mb-2">{stat.val}</div>
                  <div className="text-xs font-bold text-[#ef7f25] uppercase mb-2">{stat.label}</div>
          ...
          <div className="space-y-4">
            {[
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                variants={fadeInUp}
                className="group bg-white border border-gray-200 p-6 hover:border-[#760015] transition-colors flex flex-col md:flex-row gap-6 items-start"
              >
                <div className="w-10 h-10 flex items-center justify-center bg-[#faf9f6] text-[#760015] font-bold font-mono text-lg shrink-0 group-hover:bg-[#760015] group-hover:text-white transition-colors">
                  0{i+1}
                </div>
                <div>
        ...
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-12 gap-20">
          ...
          <div className="lg:col-span-4 h-full">
            <div className="sticky top-32">
              ...
              <h3 className="text-4xl font-bold text-[#2d2a2a] mb-8">
              ...
              <Link to="/contact" className="text-[#760015] font-bold text-sm border-b border-[#760015] pb-1 hover:text-[#ef7f25] hover:border-[#ef7f25] transition-colors">
                Get a Roadmap &rarr;
              </Link>
            </div>
          </div>
          ...
          <div className="lg:col-span-8 space-y-24">
            {[
              ...
              >
                <div className="absolute top-0 right-0 w-24 h-24 bg-gray-100 rounded-bl-[100px] -mr-12 -mt-12 transition-all group-hover:bg-[#ef7f25] group-hover:scale-110"></div>
                
                <div className="relative z-10">
                  <div className="w-12 h-12 bg-white border border-gray-200 flex items-center justify-center text-[#760015] mb-6 shadow-sm">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {service.features.map((feat, j) => (
                      <div key={j} className="flex items-center gap-2 text-sm text-[#2d2a2a]">
                        <div className="w-1.5 h-1.5 bg-[#ef7f25] rounded-full"></div>
                        {feat}
                      </div>
                    ))}
                  </div>
        ...
        <div className="max-w-[1000px] mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 relative">
            ...
            <div className="text-right md:pr-12 space-y-12">
              <div>
                <h4 className="font-bold text-[#2d2a2a] text-lg mb-2">Storage & Compute</h4>
                <p className="text-sm text-gray-500">High IOPS storage and GPU clusters to handle massive datasets and model training.</p>
              </div>
              <div>
                <h4 className="font-bold text-[#2d2a2a] text-lg mb-2">Networking</h4>
            ...
            <div className="md:pl-12 space-y-12">
              <div>
                <h4 className="font-bold text-[#2d2a2a] text-lg mb-2">Data Quality</h4>
                <p className="text-sm text-gray-500">Automated cleansing pipelines to remove noise and ensure AI accuracy.</p>
              </div>
              <div>
                <h4 className="font-bold text-[#2d2a2a] text-lg mb-2">Security Layer</h4>
          ...
          <div className="space-y-px bg-gray-200 border border-gray-200">
            {[
              ...
              <div key={i} className="bg-white">
                ...
                >
                  <span className="font-bold text-[#2d2a2a] text-sm">{faq.q}</span>
                  {openFaq === i ? <Icons.Minus className="w-4 h-4 text-[#ef7f25]" /> : <Icons.Plus className="w-4 h-4 text-gray-400" />}
                </button>
                <AnimatePresence>
                  {openFaq === i && (
                    <motion.div 
      ...
      <section className="py-24 bg-[#760015] px-6 text-center text-white">
        <div className="max-w-3xl mx-auto">
          ...
          <Link 
            to="/contact" 
            className="inline-block px-12 py-5 bg-white text-[#760015] font-bold text-xs uppercase tracking-[0.2em] hover:bg-[#ef7f25] hover:text-white transition-colors rounded-none"
          >
