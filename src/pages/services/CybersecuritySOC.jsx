      ...
      <section className="relative pt-32 pb-24 lg:pt-40 px-6 lg:px-12 max-w-[1800px] mx-auto border-b border-gray-100">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              <Icons.Shield className="w-4 h-4 text-[#ef7f25]" />
            ...
            >
              <Link 
                to="/contact" 
                className="px-10 py-4 bg-[#760015] text-white font-bold text-xs uppercase tracking-widest hover:bg-[#5a0010] transition-colors rounded-none shadow-lg"
              >
          ...
          <div className="h-[500px] flex items-center justify-center relative border-l border-gray-100 lg:pl-16">
            <div className="relative w-full max-w-md aspect-square flex items-center justify-center">
              ...
              >
                ...
                <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-gradient-to-bl from-[#760015]/20 via-[#760015]/5 to-transparent origin-bottom-left transform translate-y-[0.5px] -translate-x-[0.5px]"></div>
                
                {/* The Leading Edge Line */}
                <div className="absolute top-1/2 left-1/2 w-1/2 h-[1px] bg-[#760015]/40 origin-left -translate-y-1/2"></div>
              </motion.div>

              {/* Central Shield */}
              <div className="relative z-10 w-24 h-24 bg-white border-2 rounded-full border-[#760015] flex items-center justify-center shadow-lg">
                <Icons.Lock className="w-10 h-10 text-[#760015]" />
              </div>
              ...
              {[0, 1, 2].map((i) => (
                <motion.div
                  key={i}
                  className="absolute w-3 h-3 bg-[#ef7f25] rounded-full shadow-[0_0_10px_#ef7f25]"
                  initial={{ opacity: 0 }}
              ...
              <div className="absolute bottom-0 right-0 bg-white border border-gray-200 px-4 py-2 shadow-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-[#2d2a2a] uppercase tracking-widest">Active Monitoring</span>
                </div>
              </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-white p-8 border border-gray-200">
              <h4 className="font-bold text-[#2d2a2a] mb-6 border-b border-gray-100 pb-4">The Unified Model</h4>
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between group">
                    <span className="text-sm font-medium text-gray-500 group-hover:text-[#760015] transition-colors">{item}</span>
                    <Icons.Check className="w-4 h-4 text-[#ef7f25]" />
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-px bg-gray-200 border border-gray-200">
            ...
            >
              <div className="mb-6 flex justify-between items-start">
                <div className="p-3 bg-gray-50 border border-gray-200 text-[#760015]">
                  <Icons.Shield className="w-6 h-6" />
                </div>
                <span className="text-xs font-mono text-gray-400">01</span>
              </div>
              <h4 className="text-xl font-bold text-[#2d2a2a] mb-4">Data Security</h4>
              ...
              <ul className="space-y-2">
                <li className="flex gap-2 text-xs font-bold text-[#2d2a2a] uppercase tracking-wide">
                  <span className="text-[#ef7f25]">+</span> Data Discovery
                </li>
                <li className="flex gap-2 text-xs font-bold text-[#2d2a2a] uppercase tracking-wide">
                  <span className="text-[#ef7f25]">+</span> Cloud Protection
                </li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <h4 className="text-xl font-bold text-[#2d2a2a] mb-4">App & API Security</h4>
              <p className="text-sm text-gray-500 mb-6 leading-relaxed">
              ...
              <ul className="space-y-2">
                <li className="flex gap-2 text-xs font-bold text-[#2d2a2a] uppercase tracking-wide">
                  <span className="text-[#ef7f25]">+</span> WAF & DDoS
                </li>
                <li className="flex gap-2 text-xs font-bold text-[#2d2a2a] uppercase tracking-wide">
                  <span className="text-[#ef7f25]">+</span> API Governance
                </li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <h4 className="text-xl font-bold text-[#2d2a2a] mb-4">Identity & Access</h4>
              <p className="text-sm text-gray-500 mb-6 leading-relaxed">
              ...
              <ul className="space-y-2">
                <li className="flex gap-2 text-xs font-bold text-[#2d2a2a] uppercase tracking-wide">
                  <span className="text-[#ef7f25]">+</span> MFA & SSO
                </li>
                <li className="flex gap-2 text-xs font-bold text-[#2d2a2a] uppercase tracking-wide">
                  <span className="text-[#ef7f25]">+</span> Privileged Access
                </li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <h4 className="text-xl font-bold text-[#2d2a2a] mb-4">Software & Monetization</h4>
              <p className="text-sm text-gray-500 mb-6 leading-relaxed">
              ...
              <ul className="space-y-2">
                <li className="flex gap-2 text-xs font-bold text-[#2d2a2a] uppercase tracking-wide">
                  <span className="text-[#ef7f25]">+</span> IP Protection
                </li>
                <li className="flex gap-2 text-xs font-bold text-[#2d2a2a] uppercase tracking-wide">
                  <span className="text-[#ef7f25]">+</span> License Mgmt
                </li>
              </ul>
            </motion.div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="p-6 bg-white border border-gray-200">
                <div className="text-4xl font-bold text-[#760015] mb-2">{stat.val}</div>
