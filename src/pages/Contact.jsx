              ...
              <div className="bg-white p-8 lg:p-14 border border-gray-100 shadow-xl">
                ...
                <form ref={formRef} onSubmit={sendEmail} className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                        <input type="text" name="first_name" value={formData.first_name} onChange={handleChange} placeholder="First name" className={`w-full px-5 py-4 bg-[#fcfcfc] border ${errors.first_name ? 'border-red-500' : 'border-gray-100'} focus:border-[#ef7f25] outline-none text-sm`} />
                        {errors.first_name && <p className="text-red-500 text-[10px] uppercase font-bold mt-1">{errors.first_name}</p>}
                    </div>
                    <div>
                        <input type="text" name="last_name" value={formData.last_name} onChange={handleChange} placeholder="Last name" className={`w-full px-5 py-4 bg-[#fcfcfc] border ${errors.last_name ? 'border-red-500' : 'border-gray-100'} focus:border-[#ef7f25] outline-none text-sm`} />
                        {errors.last_name && <p className="text-red-500 text-[10px] uppercase font-bold mt-1">{errors.last_name}</p>}
                    </div>
                  </div>

                  <div>
                    <input type="text" name="company" value={formData.company} onChange={handleChange} placeholder="Company / Organization" className={`w-full px-5 py-4 bg-[#fcfcfc] border ${errors.company ? 'border-red-500' : 'border-gray-100'} focus:border-[#ef7f25] outline-none text-sm`} />
                    {errors.company && <p className="text-red-500 text-[10px] uppercase font-bold mt-1">{errors.company}</p>}
                  </div>

                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                        <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="Company email" className={`w-full px-5 py-4 bg-[#fcfcfc] border ${errors.email ? 'border-red-500' : 'border-gray-100'} focus:border-[#ef7f25] outline-none text-sm`} />
                    ...
                    <div>
                        <div className="flex gap-2">
                            <select 
                                ...
                                className="w-24 px-2 py-4 bg-[#fcfcfc] border border-gray-100 focus:border-[#ef7f25] outline-none text-sm cursor-pointer"
                            >
                                {COUNTRY_CODES.map((c) => (
                            ...
                            <input 
                                ...
                                className={`flex-1 px-5 py-4 bg-[#fcfcfc] border ${errors.phone ? 'border-red-500' : 'border-gray-100'} focus:border-[#ef7f25] outline-none text-sm`} 
                            />
                        </div>
                  ...
                  <div>
                    <textarea name="message" value={formData.message} onChange={handleChange} rows="4" placeholder="Message" className={`w-full px-5 py-4 bg-[#fcfcfc] border ${errors.message ? 'border-red-500' : 'border-gray-100'} focus:border-[#ef7f25] outline-none text-sm resize-none`}></textarea>
