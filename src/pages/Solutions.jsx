...
const caseStudies = [
  { id: 1, industry: "BFSI", outcome: "40% reduction in audit cycle time", desc: "How a regional bank unified their risk controls using Baarez GRC.", link: "/solutions/grc" },
...
const getBadgeStyles = (type) => {
    switch(type) {
        case 'Core Platform': return 'bg-[#760015] text-white border-[#760015]';
        case 'AI Accelerator': return 'bg-[#ef7f25]/10 text-[#ef7f25] border-[#ef7f25]/30';
...
const SolutionCard = ({ item }) => {
  return (
    <Link 
      to={item.path}
      className="group relative flex flex-col h-full bg-white p-6 rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 border-l-4 border-transparent hover:border-[#760015]"
    >
      {/* Header: Icon & Badge */}
      <div className="flex justify-between items-start mb-6">
          <div className="w-12 h-12 flex items-center justify-start text-[#760015]">
      ...
      <div className="flex-1">
        <h3 className="text-xl font-bold text-gray-900 mb-4 group-hover:text-[#760015] transition-colors">
          {item.name}
        </h3>
        ...
        <div className="space-y-3 mb-6">
            ...
            <div className="flex items-start gap-2">
                <Icons.Check className="w-4 h-4 text-[#760015] mt-0.5 shrink-0" />
                <p className="text-xs text-gray-600"><span className="font-semibold text-gray-900">Outcome:</span> {item.outcome}</p>
            </div>
            <div className="flex items-start gap-2">
                <Icons.Layers className="w-4 h-4 text-[#ef7f25] mt-0.5 shrink-0" />
                <p className="text-xs text-gray-600"><span className="font-semibold text-gray-900">Synergy:</span> {item.synergy}</p>
            </div>
        </div>
      </div>

      <div className="flex items-center text-sm font-bold text-[#ef7f25] mt-auto uppercase tracking-wide pt-4 border-t border-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {[
                    ...
                    <div key={i} className="flex flex-col items-center text-center p-4 bg-gray-50 rounded-lg border border-gray-100 hover:border-[#ef7f25] transition-colors">
                        <span className="text-xs text-gray-500 mb-1">Problem: {item.problem}</span>
                        <div className="h-4 w-[1px] bg-gray-300 my-1"></div>
                        <span className="text-sm font-bold text-[#760015]">Solved by: {item.solved}</span>
                    </div>
                ))}
            </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
                <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center border border-gray-100 shrink-0"><Icons.Layers className="w-5 h-5 text-[#760015]" /></div>
                ...
                <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center border border-gray-100 shrink-0"><Icons.Robot className="w-5 h-5 text-[#760015]" /></div>
                ...
                <div className="w-px h-10 bg-gray-100 hidden md:block"></div>
                <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center border border-gray-100 shrink-0"><Icons.Server className="w-5 h-5 text-[#760015]" /></div>
              ...
              <tbody className="divide-y divide-gray-100 text-sm text-gray-600">
                {comparisonData.map((row, idx) => (
                  <tr key={idx} className="hover:bg-gray-50/50 transition-colors">
                    <td className="p-5 font-bold text-[#760015]">{row.name}</td>
                    ...
                    <td className="p-5 font-medium text-[#2d2a2a]">{row.outcome}</td>
