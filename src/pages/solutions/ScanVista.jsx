...
const ScanVisual = () => (
  <div className="relative w-full h-[550px] flex items-center justify-center">
    ...
    <div className="relative w-80 h-[28rem] bg-white border border-gray-200 rounded-lg shadow-2xl z-10 overflow-visible">
      ...
      {/* The Scanning Beam */}
      <motion.div 
        className="absolute top-0 left-0 w-full h-16 bg-gradient-to-b from-[#ef7f25]/20 to-transparent border-t-2 border-[#ef7f25] shadow-[0_0_20px_rgba(239,127,37,0.3)] pointer-events-none"
        animate={{ top: ["0%", "100%", "0%"] }}
      ...
      <motion.div 
        className="absolute top-1/4 -right-32 bg-white p-4 rounded-lg shadow-xl border border-[#ef7f25]/20 z-50 w-48"
      ...
      <motion.div 
        className="absolute bottom-1/4 -left-32 bg-white p-4 rounded-lg shadow-xl border border-[#760015]/20 z-50 w-48"
        initial={{ opacity: 0, x: 20, scale: 0.9 }}
        animate={{ opacity: [0, 1, 1, 0], x: [20, 0, 0, -20], scale: 1 }}
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-[#2d2a2a] selection:bg-[#ef7f25] selection:text-white">
      ...
      <section className="py-24 px-8 lg:px-20 bg-white">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid lg:grid-cols-3 gap-12 items-center">
            ...
            {/* Step 2: Engine */}
            <div className="relative p-10 border border-[#ef7f25]/20 rounded-2xl bg-[#ef7f25]/5 text-center shadow-lg transform scale-105 z-10">
              <div className="w-20 h-20 bg-[#ef7f25] rounded-full mx-auto flex items-center justify-center shadow-lg mb-6 text-white animate-pulse">
                <Icons.Lightning className="w-10 h-10" />
              </div>
              <h3 className="text-xl font-bold text-[#2d2a2a] mb-2">2. ScanVista Core</h3>
      ...
      <section className="py-24 px-8 lg:px-20 bg-[#f9fafb]">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="bg-white p-12 rounded-2xl border border-gray-200 shadow-sm relative overflow-hidden">
            {/* Background Stripe */}
            <div className="absolute top-0 left-0 w-2 h-full bg-[#760015]"></div>
            
            <div className="grid md:grid-cols-3 gap-12 divide-y md:divide-y-0 md:divide-x divide-gray-100">
              <div className="text-center md:text-left">
                <div className="flex items-center gap-3 mb-4 text-[#760015]">
                  <Icons.Clock className="w-6 h-6" />
                  <span className="font-bold uppercase tracking-wider text-xs">Speed</span>
                </div>
                <h3 className="text-4xl font-light text-[#2d2a2a] mb-2">3 Days</h3>
              ...
              <div className="text-center md:text-left md:pl-12">
                ...
                <h3 className="text-4xl font-light text-[#2d2a2a] mb-2">4% Error</h3>
              ...
              <div className="text-center md:text-left md:pl-12">
                ...
                <h3 className="text-4xl font-light text-[#2d2a2a] mb-2">Limited</h3>
      ...
      <section id="features" className="py-24 px-8 lg:px-20 bg-white">
        <div className="max-w-[1400px] mx-auto">
          <div className="mb-20">
            <h2 className="text-4xl font-bold text-[#2d2a2a]">Platform Capabilities</h2>
            <div className="h-1 w-20 bg-[#ef7f25] mt-4"></div>
          </div>

          <div className="grid md:grid-cols-3 gap-6">
            
            {/* Feature 1: Large Card (Spans 2 cols) */}
            <div className="md:col-span-2 bg-[#fdfbf9] p-10 rounded-xl border border-gray-100 flex flex-col md:flex-row gap-8 items-center group hover:border-[#ef7f25] transition-colors">
            ...
            <div className="md:row-span-2 bg-white p-10 rounded-xl border border-gray-200 hover:shadow-xl transition-shadow flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-xl font-bold text-[#2d2a2a] mb-3">Bilingual Core</h3>
              ...
              <div className="mt-8 pt-8 border-t border-gray-100">
                ...
                <div className="w-full h-2 bg-gray-100 rounded-full mt-2">
                  <div className="w-full h-full bg-[#760015] rounded-full"></div>
                </div>
              </div>
            </div>
            ...
            {[
              ...
              <button
                ...
                className={`px-6 py-3 rounded-full text-sm font-bold transition-all ${
                  activeTab === tab.id 
                    ? 'bg-[#2d2a2a] text-white shadow-lg' 
              ...
              {activeTab === 'invoice' && (
                ...
                >
                  <div>
                    ...
                    <ul className="space-y-2 text-sm font-bold text-[#760015]">
      ...
      <section className="py-20 bg-[#760015] text-white">
      ...
      <section className="py-32 px-8 lg:px-20 bg-white">
        <div className="max-w-4xl mx-auto bg-white border border-gray-200 p-12 lg:p-16 rounded-2xl shadow-2xl text-center relative overflow-hidden">
          {/* Decor */}
          <div className="absolute top-0 right-0 w-32 h-32 bg-[#ef7f25]/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#760015]/10 rounded-full blur-3xl"></div>
          ...
          <div className="relative z-10">
            ...
            <Link 
              to="/contact" 
              className="inline-block px-12 py-5 bg-[#760015] text-white font-bold text-sm uppercase tracking-widest hover:bg-[#5a0010] transition-colors rounded-sm shadow-lg"
            >
              Book A Demo
            </Link>
          </div>
