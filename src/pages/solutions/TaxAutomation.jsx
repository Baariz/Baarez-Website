      ...
      <section className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 px-6 lg:px-16 overflow-hidden bg-white border-b border-gray-100">
        <div className="max-w-[1600px] mx-auto grid lg:grid-cols-2 gap-20 items-center relative z-10">
          ...
          <div>
            ...
            >
              <div className="w-8 h-[1px] bg-[#760015]"></div>
              <span className="text-[#760015] font-bold uppercase tracking-[0.2em] text-xs">
                EmaraTax Automation
              </span>
            </motion.div>
            ...
            >
              <Link to="/contact" className="px-8 py-4 bg-[#760015] text-white font-bold text-sm uppercase tracking-widest hover:bg-[#5a0010] transition-colors rounded-none text-center">
                Start Filing
              </Link>
          ...
          <div className="relative h-[500px] bg-[#fbf9f8] border border-gray-100 flex items-center justify-center overflow-hidden">
            ...
            <div className="relative w-full max-w-lg h-full flex flex-col justify-center gap-6 p-8">
               ...
               {['Data Ingestion', '9% Computation', 'FTA Filing'].map((stage, i) => {
                 const isLast = i === 2;
                 const accentColor = isLast ? '#22c55e' : '#ef7f25'; // Green for last, Orange otherwise
                  ...
                  <div key={i} className="relative h-20 bg-white border border-gray-200 flex items-center px-2 overflow-hidden shadow-sm">
                      ...
                      >
                        ...
                        {isLast ? (
                            ...
                            <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center text-[#ef7f25]">
               ...
               <div className="absolute bottom-0 left-0 w-full h-1.5 bg-gray-100">
                  <motion.div
                    ...
                    className="h-full bg-gradient-to-r from-[#ef7f25] via-[#760015] to-green-500"
                  ></motion.div>
               </div>
            </div>
        ...
        <div className="max-w-[1800px] mx-auto px-8 relative">
          <div className="grid md:grid-cols-4 gap-12 text-center md:text-left divide-y md:divide-y-0 md:divide-x divide-white/10">
            <div className="md:px-8">
              <h3 className="text-[#ef7f25] text-sm font-bold uppercase tracking-widest mb-2">Mandate</h3>
              <p className="text-2xl font-light">Federal Decree-Law No. 47</p>
            </div>
            <div className="md:px-8">
              <h3 className="text-[#ef7f25] text-sm font-bold uppercase tracking-widest mb-2">Rate</h3>
              <p className="text-2xl font-light">9% on Income &gt; AED 375k</p>
            </div>
            <div className="md:px-8">
              <h3 className="text-[#ef7f25] text-sm font-bold uppercase tracking-widest mb-2">Deadline</h3>
              <p className="text-2xl font-light">9 Months from FY End</p>
            </div>
            <div className="md:px-8">
              <h3 className="text-[#ef7f25] text-sm font-bold uppercase tracking-widest mb-2">Action</h3>
                ...
                <div className="relative w-full h-full max-h-[600px] overflow-hidden shadow-2xl">
                  ...
                  <div className="absolute bottom-0 left-0 w-full bg-white/95 backdrop-blur px-8 py-6 border-t border-gray-200">
                    <div className="flex items-center gap-4">
                      <div className="p-3 bg-gray-100 text-[#760015] rounded-none">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-bold text-[#2d2a2a]">{feature.subtitle} Active</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-32 px-8 lg:px-24 bg-[#fdfbf9]">
        <div className="max-w-[1600px] mx-auto">
          <div className="mb-20 text-center max-w-3xl mx-auto">
            ...
            <h3 className="text-4xl font-bold text-[#2d2a2a]">
          ...
          <div className="grid md:grid-cols-3 gap-1">
            {[
              ...
              <div key={i} className="bg-white p-12 hover:bg-[#760015] hover:text-white transition-all duration-500 group border border-gray-100">
      ...
      <section className="py-32 bg-white px-8 lg:px-24 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <Link 
              to="/contact" 
              className="inline-block px-12 py-5 bg-[#2d2a2a] text-white font-bold text-sm uppercase tracking-[0.2em] hover:bg-[#ef7f25] transition-colors rounded-none"
            >
