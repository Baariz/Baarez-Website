...
const Glimmora = () => {
  return (
    <div className="bg-white font-sans text-[#2d2a2a] selection:bg-[#ef7f25] selection:text-white">
      ...
      <section className="relative pt-32 lg:pt-12 pb-24 px-6 lg:px-12 border-b border-gray-100 overflow-hidden bg-[#fafafa]">
        ...
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-b from-[#fff5eb] to-transparent rounded-full blur-3xl -z-10 translate-x-1/3 -translate-y-1/4 opacity-60"></div>
        ...
        <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <span className="text-[#ef7f25] font-bold uppercase tracking-widest text-xs">
            ...
            >
              <button className="px-8 py-4 bg-[#760015] text-white font-bold text-xs uppercase tracking-widest hover:bg-[#5a0010] transition-all shadow-lg rounded-sm">
                 <Link to="/contact" >Request a Demo</Link>
              </button>
              <a href="#capabilities" className="px-8 py-4 bg-white border border-gray-200 text-[#2d2a2a] font-bold text-xs uppercase tracking-widest hover:border-[#ef7f25] hover:text-[#ef7f25] transition-all rounded-sm">
          ...
          <div className="relative h-[600px] w-full hidden lg:flex items-center justify-center">
             ...
             >
                ...
                <div className="space-y-4">
                   ...
                   <div className="h-32 w-full bg-gradient-to-t from-[#fff5eb] to-transparent rounded-lg border border-[#ef7f25]/10 relative mt-4">
                      {/* Abstract Chart Line */}
                      <svg className="absolute bottom-0 left-0 w-full h-full" preserveAspectRatio="none">
                         <path d="M0,100 C100,80 200,120 300,60 S400,20 500,10" fill="none" stroke="#ef7f25" strokeWidth="2" />
                      </svg>
                   </div>
                </div>
             </motion.div>
             ...
             >
                ...
                <div className="w-full h-1 bg-gray-100 mt-3 rounded-full overflow-hidden">
                   <div className="w-[85%] h-full bg-[#ef7f25]"></div>
                </div>
             </motion.div>

             {/* 4. Abstract Connection Lines */}
             <svg className="absolute inset-0 w-full h-full pointer-events-none z-0 opacity-20">
                <line x1="50%" y1="50%" x2="80%" y2="20%" stroke="#760015" strokeWidth="1" strokeDasharray="5,5" />
                <line x1="50%" y1="50%" x2="20%" y2="70%" stroke="#ef7f25" strokeWidth="1" strokeDasharray="5,5" />
             </svg>
      ...
      <section className="py-24 px-6 lg:px-12 max-w-[1000px] mx-auto text-center">
        <h2 className="text-[#ef7f25] font-bold text-xs uppercase tracking-[0.3em] mb-6">The Platform</h2>
      ...
      {/* 3. CORE CAPABILITIES */}
      <section id="capabilities" className="py-24 bg-[#760015] text-white">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="mb-16">
            <h2 className="text-[#ef7f25] font-bold text-xs uppercase tracking-[0.3em] mb-4">Capabilities</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="group border-t border-[#ef7f25]/30 pt-8 hover:border-[#ef7f25] transition-colors duration-500">
                <span className="block text-[#ef7f25] font-mono text-xs mb-4">0{i+1}</span>
                <h4 className="text-xl font-bold mb-4">{cap.title}</h4>
                <p className="text-white/70 text-sm leading-relaxed font-light border-l border-white/10 pl-4 group-hover:border-[#ef7f25] transition-colors">
                  {cap.desc}
                </p>
              </div>
            ))}
      ...
      <section className="py-24 px-6 lg:px-12 max-w-[1400px] mx-auto bg-[#fafafa]">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <ul className="space-y-4">
              {["Standardized decision frameworks", "Real-time portfolio visibility", "Automated compliance monitoring"].map((item, i) => (
                <li key={i} className="flex items-center gap-3 text-sm font-bold text-[#2d2a2a] uppercase tracking-wide">
                  <span className="w-1.5 h-1.5 bg-[#ef7f25] rounded-full"></span>
                  {item}
                </li>
              ))}
            </ul>
          ...
          <div className="bg-white p-10 border border-gray-100 shadow-xl rounded-xl">
            <h4 className="text-sm font-bold text-[#ef7f25] uppercase tracking-widest mb-6">Ideal for</h4>
            <div className="grid grid-cols-1 gap-6">
              {[
                ...
                <div key={i} className="flex items-start gap-4 pb-4 border-b border-gray-50 last:border-0">
                  <div className="text-[#760015] font-mono text-lg font-bold">/</div>
                  <div>
                    <p className="font-bold text-[#2d2a2a]">{target.label}</p>
