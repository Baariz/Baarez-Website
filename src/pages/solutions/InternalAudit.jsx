...
const AuditVisual = () => (
  <div className="relative w-full h-[450px] flex items-center justify-center">
    ...
    <div className="relative z-10 w-64 h-64 bg-white rounded-2xl shadow-2xl border border-gray-100 flex flex-col items-center justify-center">
        <div className="w-16 h-16 bg-[#760015]/5 rounded-full flex items-center justify-center mb-4">
            <Icons.ClipboardCheck className="w-8 h-8 text-[#760015]" />
        </div>
        <div className="text-center px-6">
            <div className="text-sm font-bold text-[#2d2a2a] mb-1">Audit Intelligent Engine</div>
    ...
    <div className="absolute right-0 top-1/2 -translate-y-1/2">
        ...
        <div className="bg-white p-4 rounded-lg shadow-lg border border-gray-100 border-l-4 border-l-[#ef7f25] w-48 mb-4 ml-8">
            <div className="h-2 w-12 bg-gray-200 rounded mb-2"></div>
            <div className="h-2 w-24 bg-gray-100 rounded"></div>
        </div>
        <div className="bg-white p-4 rounded-lg shadow-lg border border-gray-100 border-l-4 border-l-[#760015] w-48">
            <div className="h-2 w-12 bg-gray-200 rounded mb-2"></div>
            <div className="h-2 w-24 bg-gray-100 rounded"></div>
        </div>
    </div>
...
const InternalAudit = () => {
  return (
    <div className="min-h-screen bg-white font-sans text-[#2d2a2a] pt-5  selection:bg-[#ef7f25] selection:text-white">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-all">
                <div className="w-12 h-12 bg-gray-50 rounded-lg flex items-center justify-center text-[#760015] mb-6">
                  <item.icon className="w-6 h-6" />
                </div>
                <h3 className="text-xl font-bold text-[#2d2a2a] mb-3">{item.title}</h3>
      ...
      <section id="how-it-works" className="py-24 px-8 lg:px-20 bg-white">
        <div className="max-w-[1600px] mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 border-b border-gray-100 pb-8">
            <div>
              <span className="text-[#ef7f25] font-bold text-xs uppercase tracking-widest mb-2 block">Platform Capabilities</span>
              <h2 className="text-4xl font-bold text-[#2d2a2a]">How Baarez Audit Works</h2>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="group p-8 border border-gray-200 hover:border-[#760015] transition-all bg-white rounded-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
              {[
                ...
                <div key={i} className="bg-white p-6 border border-gray-200 shadow-sm rounded-lg text-center hover:-translate-y-2 transition-transform duration-300">
                  <div className="w-10 h-10 bg-[#760015] text-white rounded-full flex items-center justify-center mx-auto mb-4 font-bold text-sm">
                    {phase.step}
                  </div>
                  <h3 className="text-xl font-bold text-[#2d2a2a] mb-2">{phase.title}</h3>
      ...
      <div className="hidden lg:block lg:col-span-5 relative overflow-hidden h-full min-h-[400px] bg-white border-l border-gray-100">
        <div className="absolute inset-0 opacity-20">
          <svg className="w-full h-full" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="400" cy="400" r="300" stroke="#ef7f25" strokeWidth="2" strokeDasharray="8 8" />
            <circle cx="400" cy="400" r="200" stroke="#760015" strokeWidth="2" strokeDasharray="4 4" />
            <circle cx="400" cy="400" r="100" stroke="#ef7f25" strokeWidth="1" />
          </svg>
        </div>
        {/* Floating Abstract Nodes */}
        <div className="absolute top-1/4 left-1/4 w-3 h-3 bg-[#760015] rounded-full"></div>
        <div className="absolute bottom-1/3 right-1/3 w-4 h-4 bg-[#ef7f25] rounded-full"></div>
        <div className="absolute top-1/2 right-1/4 w-2 h-2 bg-[#2d2a2a] rounded-full"></div>
        {/* Subtle connecting lines */}
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
          <line x1="25" y1="25" x2="75" y2="50" stroke="#760015" strokeWidth="0.5" opacity="0.2" />
          <line x1="75" y1="50" x2="66" y2="66" stroke="#ef7f25" strokeWidth="0.5" opacity="0.3" />
        </svg>
        
        <div className="absolute bottom-8 left-8 bg-white p-4 rounded-lg shadow-md border border-gray-100">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
            <span className="text-xs font-bold text-[#2d2a2a] uppercase">Audit Status</span>
          </div>
          <div className="text-sm font-bold text-[#760015]">Modernized & Audit-Ready</div>
        </div>
      </div>
      ...
      <div className="lg:col-span-7 p-12 lg:p-20 flex flex-col justify-center relative z-10">
        <div className="inline-block mb-6">
          <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-full px-4 py-2 shadow-sm">
            <div className="w-3 h-3 bg-[#760015] rounded-full"></div>
            <span className="text-xs font-bold text-[#2d2a2a] uppercase tracking-wider">Next Steps</span>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-5">
          <Link 
            to="/contact" 
            className="inline-flex items-center justify-center px-10 py-5 bg-[#760015] text-white font-bold text-sm uppercase tracking-widest hover:bg-[#5a0010] transition-all shadow-xl rounded-sm"
          >
            Schedule a Consultation
          </Link>
          <Link 
            to="/about" 
            className="inline-flex items-center justify-center px-10 py-5 bg-white border-2 border-gray-200 text-[#2d2a2a] font-bold text-sm uppercase tracking-widest hover:border-[#760015] hover:text-[#760015] transition-all rounded-sm"
          >
            Why Baarez?
          </Link>
        </div>
