    ...
    <div className="min-h-screen bg-white font-sans text-[#2d2a2a] selection:bg-[#ef7f25] selection:text-white overflow-x-hidden">
        ...
        >
          ...
          <div className="lg:col-span-7 p-8 lg:p-16 border-b lg:border-b-0 lg:border-r border-gray-200 bg-white relative flex flex-col justify-center">
            ...
            <div className="flex gap-4">
              <Link 
                to="/contact" 
                className="px-8 py-4 bg-[#760015] text-white font-bold text-xs uppercase tracking-widest hover:bg-[#5a0010] transition-colors shadow-sm rounded-none"
              >
                Get a Quote
              </Link>
              <Link 
            ...
            <motion.div variants={fadeInUp} className="bg-white p-8 border border-gray-200 shadow-sm">
              <div className="flex items-center justify-between text-center divide-x divide-gray-100">
                <div className="px-4 flex-1">
                  <Icons.Cloud className="w-8 h-8 mx-auto text-[#760015] mb-3" />
                  <h3 className="font-bold text-sm uppercase tracking-wide">Cloud Hosted</h3>
                </div>
                <div className="px-4 flex-1">
                  <Icons.Zap className="w-8 h-8 mx-auto text-[#ef7f25] mb-3" />
                  <h3 className="font-bold text-sm uppercase tracking-wide">Pay-as-you-Go</h3>
                </div>
                <div className="px-4 flex-1">
                  <Icons.Server className="w-8 h-8 mx-auto text-[#2d2a2a] mb-3" />
            ...
            <table className="w-full text-left border-collapse text-sm">
              <thead>
                <tr>
                  ...
                  <th className="p-4 border-b-2 border-[#760015] text-[#760015] font-bold w-1/3 bg-[#fff5f0]">Baarez RaaS</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} className="group hover:bg-gray-50/50 transition-colors">
                    <td className="p-4 border-b border-gray-100 font-medium text-[#2d2a2a]">{row.feat}</td>
                    <td className="p-4 border-b border-gray-100 text-gray-500">{row.old}</td>
                    <td className="p-4 border-b border-gray-100 text-[#760015] font-bold">{row.new}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <section className="py-20 bg-[#fdfbf9]">
        <div className="max-w-[1200px] mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={i} className="flex items-center gap-3">
                  <div className="w-4 h-4 bg-[#760015] text-white flex items-center justify-center rounded-none">
                    <Icons.Check className="w-3 h-3" />
                  </div>
                  <span className="font-bold text-[#2d2a2a] text-sm">{item}</span>
                </li>
              ))}
            </ul>
          </motion.div>
          ...
          >
            <div className="absolute top-0 right-0 w-full h-full border border-[#ef7f25] translate-x-3 translate-y-3"></div>
            <img 
        ...
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="p-6 border border-white/10 hover:border-[#ef7f25] transition-colors bg-white/5 backdrop-blur-sm">
                <h3 className="text-[#ef7f25] font-bold mb-2 text-sm uppercase tracking-wide">{item.role}</h3>
      ...
      <section className="py-24 bg-white px-6 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-4xl font-bold text-[#2d2a2a] mb-6">
          ...
          <Link 
            to="/contact" 
            className="inline-block px-10 py-4 bg-[#2d2a2a] text-white font-bold text-xs uppercase tracking-[0.2em] hover:bg-[#ef7f25] transition-colors rounded-none"
          >
            Book Discovery Call
          </Link>
        </div>
