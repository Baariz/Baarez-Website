...
const PerimeterVisual = () => {
  return (
    <div className="relative w-full h-[600px] flex items-center justify-center">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(#760015_1px,transparent_1px)] [background-size:40px_40px] opacity-[0.03]"></div>
      <div className="absolute w-[500px] h-[500px] bg-[#ef7f25]/5 rounded-full blur-3xl"></div>
      ...
      <div className="relative z-20 w-32 h-32 bg-white rounded-full border-4 border-gray-50 shadow-[0_0_40px_-10px_rgba(118,0,21,0.2)] flex items-center justify-center">
        <div className="absolute inset-0 rounded-full border border-[#760015]/10 animate-ping opacity-20"></div>
      ...
      <motion.div 
        className="absolute top-1/2 left-0 transform -translate-y-1/2 bg-white/80 backdrop-blur-md p-4 rounded-lg border-l-4 border-[#760015] shadow-xl z-10 w-60"
        animate={{ y: ["-50%", "-55%", "-50%"] }} // Centered adjustment
        transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 1 }}
      >
        <div className="flex justify-between items-start mb-3">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded bg-[#760015]/10 flex items-center justify-center text-[#760015]">
...
const TPRM = () => {
  return (
    <div className="min-h-screen bg-white font-sans text-[#2d2a2a] selection:bg-[#ef7f25] selection:text-white">
            ...
            <div className="relative group cursor-default">
              <div className="absolute inset-0 bg-white/60 backdrop-blur-[2px] z-10 flex items-center justify-center border border-gray-100 rounded-xl transition-all duration-500 group-hover:backdrop-blur-none group-hover:bg-transparent">
                <div className="bg-white px-6 py-3 shadow-lg border border-gray-100 rounded-full group-hover:opacity-0 transition-opacity duration-300">
                  <span className="text-[#760015] font-bold text-sm flex items-center gap-2">
      ...
      {/* --- 3. THE SOLUTION: "How Baarez Helps" (Clean Cards) --- */}
        ...
        <div className="max-w-[1600px] mx-auto px-8 lg:px-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-10 rounded-sm border border-gray-100 hover:border-[#ef7f25] hover:shadow-xl transition-all duration-300 group">
                <div className="w-12 h-12 bg-[#fafafa] rounded-full flex items-center justify-center mb-6 text-[#2d2a2a] group-hover:bg-[#ef7f25] group-hover:text-white transition-colors">
                  <card.icon className="w-6 h-6" />
                </div>
                <h3 className="text-xl font-bold text-[#2d2a2a] mb-3">{card.title}</h3>
...
<div className="py-16 bg-white border-t border-gray-100 relative overflow-hidden">
  <Section>
    ...
    <div className="relative rounded-2xl bg-[#fdfbf9] border border-gray-200 overflow-hidden p-8 md:p-10 shadow-xl">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(rgba(118,0,21,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(118,0,21,0.03)_1px,transparent_1px)] bg-[size:40px_40px]"></div>
          ...
          <FadeIn>
            <div className="flex items-center gap-3 mb-4">
              <span className="relative flex h-2.5 w-2.5">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#ef7f25] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#ef7f25]"></span>
              </span>
              <span className="text-[#ef7f25] font-bold font-mono text-xs tracking-widest uppercase">
                Continuous Oversight
              </span>
            </div>

            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#2d2a2a]">
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                <div key={i} className="flex items-center gap-3 text-gray-700 text-sm font-medium">
                  <Icons.CheckCircle className="w-4 h-4 text-[#760015]" />
                  <span>{item}</span>
                </div>
              ))}
            </div>
        ...
        <div className="relative">
          <FadeIn delay={0.2}>
            <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-lg relative">
              ...
              {/* Decorative Top Bar */}
              <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#760015] to-[#ef7f25] rounded-t-xl"></div>

              {/* Dashboard Header */}
              <div className="flex justify-between items-center border-b border-gray-100 pb-3 mb-3 pt-1">
                <div className="text-xs font-bold text-[#760015] uppercase tracking-wider">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center p-2.5 bg-gray-50 rounded-lg border border-gray-100">
                  <div className="flex items-center gap-2">
                    <Icons.Users className="w-4 h-4 text-[#760015]" />
                    <span className="text-xs font-bold text-gray-600">
              ...
              <div className="mt-5 h-16 flex items-end justify-between gap-1">
                {[40, 55, 50, 70, 60, 80, 65, 75, 60, 85, 70, 90].map((h, i) => (
                  <motion.div 
                    ...
                    className="w-full bg-gradient-to-t from-[#760015] to-[#ef7f25] rounded-t-sm opacity-90"
                  />
                ))}
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-12 divide-y md:divide-y-0 md:divide-x divide-white/10">
            ...
            {[
              ...
              <div key={i} className="pt-8 md:pt-0 md:pl-12">
                <div className="text-5xl font-bold text-[#ef7f25] mb-2">{stat.val}</div>
      ...
      <section className="py-32 px-8 lg:px-20 bg-white text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Link 
              to="/contact" 
              className="inline-block px-12 py-5 bg-[#760015] text-white font-bold text-sm uppercase tracking-widest hover:bg-[#5a0010] transition-colors shadow-2xl rounded-sm"
            >
              Book a Demo
            </Link>
            <Link 
              to="/contact" 
              className="inline-block px-12 py-5 bg-white border border-gray-200 text-[#2d2a2a] font-bold text-sm uppercase tracking-widest hover:border-[#760015] transition-colors rounded-sm"
            >
              Talk to Sales
            </Link>
          </div>
