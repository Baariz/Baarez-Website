...
const WhitePaper = () => {
  ...
  const handleSubmit = (e) => {
    ...
    .then((result) => {
        ...
        link.href = pdfUrl;
        link.setAttribute('download', 'Baarez_GRC_Framework.pdf'); // Filename the user sees
    ...
    return (
        <div className="min-h-screen bg-white pt-32 pb-20 flex items-center justify-center">
            <div className="max-w-md w-full bg-green-50 p-8 rounded-xl border border-green-200 text-center">
                ...
                <a href="/grc-whitepaper.pdf" download="Baarez_GRC_Framework.pdf" className="inline-block bg-[#760015] text-white font-bold py-3 px-6 rounded hover:bg-[#5a0010] transition-colors">
                    Download PDF Now
                </a>
            </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#fdfbf9] pt-24 pb-20">
      ...
      <div className="bg-[#1a0505] text-white py-16 mb-12 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#ef7f25]/10 rounded-full blur-[100px] pointer-events-none translate-x-1/2 -translate-y-1/2"></div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-7 space-y-8">
                <div>
                    <span className="text-[#ef7f25] font-bold uppercase tracking-widest text-xs">White Paper</span>
                    <h2 className="text-3xl md:text-4xl font-bold text-[#2d2a2a] mt-2 mb-6">
                        A Framework for Strong GRC in a Digitally Evolving World
                    </h2>
                    <div className="w-20 h-1 bg-[#760015] mb-8"></div>
                    ...
                    <div className="prose prose-lg text-gray-600 leading-relaxed">
                        ...
                        <p className="font-semibold text-[#760015]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                    <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
                        <div className="w-10 h-10 bg-[#760015]/10 rounded-lg flex items-center justify-center text-[#760015] mb-4">
                    ...
                    <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
                        <div className="w-10 h-10 bg-[#ef7f25]/10 rounded-lg flex items-center justify-center text-[#ef7f25] mb-4">
            ...
            <div className="lg:col-span-5">
                <div className="bg-white rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-gray-200 p-6 md:p-8 sticky top-28">
                    <h3 className="text-2xl font-bold text-[#2d2a2a] mb-6 border-b border-gray-100 pb-4">
                        Get your copy
                    </h3>
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input 
                                    ...
                                    className="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#760015] focus:border-[#760015] block p-2.5" 
                                />
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <div className="flex">
                                ...
                                <input 
                                    ...
                                    onChange={handleChange}
                                    className="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-[#760015] focus:border-[#760015] block flex-1 min-w-0 w-full text-sm p-2.5" 
                        ...
                        <div className="flex items-start">
                            <div className="flex items-center h-5">
                                <input 
                                    ...
                                    onChange={handleChange}
                                    className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-[#760015] accent-[#760015]" 
                                />
                            </div>
                            <label htmlFor="privacy_consent" className="ml-2 text-xs font-medium text-gray-900">
                                I agree to allow Baarez Technology Solutions to store and process my personal data.*
                            </label>
                        </div>
                        ...
                        <button 
                            type="submit" 
                            disabled={loading}
                            className="w-full text-white bg-[#760015] hover:bg-[#5a0010] focus:ring-4 focus:outline-none focus:ring-red-300 font-bold rounded-lg text-sm px-5 py-3 text-center transition-all duration-300 disabled:opacity-50"
                        >
